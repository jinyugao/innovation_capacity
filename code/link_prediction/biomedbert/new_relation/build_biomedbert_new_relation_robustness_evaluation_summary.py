"""Build BiomedBERT new-relation robustness evaluation summaries."""
...
RESULT_DIR = PROJECT_DIR / "results/link_prediction/biomedbert/new_relation/robustness"
...
OUTPUT_FILE = RESULT_DIR / "biomedbert_new_relation_robustness_evaluation_summary.csv"
...
ANNOTATION_COLUMN = "biomedbert_new_relation_robustness_annotation"
...
def annotated_file_for_year(focal_year: int, percentile: int) -> Path:
    ...
    return (
        ...
        / label
        / (
            f"{ANNOTATED_FILE_PREFIX}_biomedbert_new_relation_robustness_top_"
...
def build_summary_row(focal_year: int, percentile: int) -> dict[str, object]:
    ...
    print(
        "Summarizing BiomedBERT new-relation robustness evaluation for "
...
def main() -> None:
    ...
    print(
        "Saved BiomedBERT new-relation robustness evaluation summary to "
        f"{OUTPUT_FILE}"
    )
